#!/usr/bin/env python3
"""Mail merge with LaTeX: reads fakenames.xml, renders LaTeX template, produces PDF."""
...
def main():
    ...
    template = env.get_template("mailmerge_template.tex")
    tex_str = template.render(records=records)

    tex_path = BASE_DIR / "mailmerge_latex.tex"
    ...
    print(f"PDF generated: mailmerge_latex.pdf ({len(records)} letters)")
